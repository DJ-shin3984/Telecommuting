...
public class MemberController {
	...
	// 카카오 회원가입 로그인 ------------------------------------------
		...
		// 회원가입 -------------------------------------
				...
				public String insertJoin(HttpServletRequest request ,Model model) throws Exception {
					...
					System.out.println("사원이름: "+member.getM_name());
					System.out.println("사원id: "+member.getM_id());
					System.out.println("사원pw: "+member.getM_pw());
					System.out.println("사원phone: "+member.getM_phone());
					System.out.println("사원subphone: "+member.getM_subphone());
					System.out.println("사원email: "+member.getM_email());
					System.out.println("사원add: "+member.getM_add());
					System.out.println("사원empdate: "+member.getM_empdate());
					System.out.println("부서번호: "+member.getD_idx());
					System.out.println("사원level: "+member.getM_level());
