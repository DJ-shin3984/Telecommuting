...
CREATE TABLE MEMBER (
	...
	M_DEPARTMENT VARCHAR2(15) NOT NULL, /* 부서명 */
...
CREATE TABLE CONFERENCE (
	C_IDX NUMBER(20) constraint M_PK primary key, /* 회의번호 */
	C_TITLE VARCHAR2(50) NOT NULL /* 회의 제목 */
	C_CONTENT VARCHAR2(200) NOT NULL /* 회의 내용 */
	M_IDX NUMBER(20) constraint M_FK foreign key, /* 사원번호 */
);

/* 게시판  */
CREATE TABLE BOARD (
	B_IDX NUMBER(20) constraint M_PK primary key, /* 게시판 번호 */
	B_TITLE VARCHAR2(50) NOT NULL /* 게시판 제목 */
	B_CONTENT VARCHAR2(200) NOT NULL /* 게시판 내용 */
	M_IDX NUMBER(20) constraint M_FK foreign key, /* 사원 번호 */
);

/* 근태  */
CREATE TABLE ATTENDANCE (
	A_IDX NUMBER(20) constraint M_PK primary key, /* 근태 번호 */
...
CREATE TABLE INDIVIDUAL_WORK (
	IW_IDX NUMBER(20) constraint M_PK primary key, /* 개인업무 번호 */
...
CREATE TABLE DEPARTMENT_WORK (
	DW_IDX NUMBER(20) constraint M_PK primary key, /* 부서 업무 번호 */
